> **Navigation:** [<-- EDA: Distributions](06-eda-distributions.md) | [Part Index](00-index.md) | [Main Index](../index.md) | [Data Understanding: Best Practices -->](08-eda-best-practices)

# EDA: Correlation and Visualizations
...
![Happiness versus self-rated health scatter plot](../media/plots/ess_wellbeing_scatter_health_vs_happiness.png)
...
where $\bar{x}$ and $\bar{y}$ are the sample means. The numerator computes the covariance (unnormalized shared variation), and the denominator divides by the product of the standard deviations of both variables (see [EDA: Descriptive Statistics](04-eda-descriptive-stats.md)).
...
![Pearson correlation heatmap for the ESS well-being dataset](../media/plots/ess_wellbeing_correlation_heatmap_pearson.png)
...
![Pair plot for the ESS well-being dataset](../media/plots/ess_wellbeing_pairplot.png)
