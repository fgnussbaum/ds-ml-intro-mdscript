...
Lab sessions are where you build hands-on skill. The format may vary: code and output reading, guided notebooks, or short exercises.
It depends on the topic. Where possible, you will work with data from your own project.

### Working on Personal Projects

The best learning happens when it is tied to personal motivation and stakes. Therefore, working on a **personal project** or a **team project** with strong motivation is strongly recommended alongside taking this course. This can be a question from your own field, approached with real data, carried through a full analysis cycle, and documented as a result.

> Your personal project: It can be small. It should be yours.

Every technical block in this course, from data handling, to modeling, to evaluation, can feed directly into what you do with your own dataset. Students who work this way consistently get more out of the course.

The full case for working on projects and how to find project ideas is covered in [🖝 Why a Project?](../part-02-ds-projects/01-why-a-project.md).
...
- Anchoring your learning in a personal projects is strongly recommended.
