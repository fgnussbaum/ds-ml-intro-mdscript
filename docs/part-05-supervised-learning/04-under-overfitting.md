...
<p><center><img src="../media/of-under-best-overfit.png" alt="Plot with underfitting (degree 0/1), best fit (degree 7; though true model has degree three, curve fits smoothly nonetheless), overfitting (degree 20)" style="width:100%"/></center></p>
...
<p><center><img src="../media/of-rsme-by-degree.png" alt="plot of train and validation RSMEs for degree 0...20." style="width:75%"/></center></p>
...
<p><center><img src="../media/of-biasvariance.png" alt="bias-variance trade-off with polynomial fit degree 0 to 10" style="width:75%"/></center></p>
