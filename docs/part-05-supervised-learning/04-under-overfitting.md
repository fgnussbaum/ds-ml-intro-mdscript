...
Consider a dataset generated from a cubic relationship with noise added. The true pattern has degree 3, but you do not know that. You fit polynomial models of increasing degree and compare how each curve follows the data.

<p><center><img src="../media/demos-screenshots/of-under-best-overfit.jpg" alt="Plot with underfitting (degree 0/1), best fit (degree 7; though true model has degree three, curve fits smoothly nonetheless), overfitting (degree 20)" width="500px"/></center></p>
...
<p><center><img src="../media/demos-screenshots/of-rsme-by-degree.jpg" alt="plot of train and validation RSMEs for degree 0...20." width="500px"/></center></p>
