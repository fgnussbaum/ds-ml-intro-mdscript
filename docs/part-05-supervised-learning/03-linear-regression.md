> **Navigation:** [<-- Train/Test Split](02-train-test-split.md) | [Part Index](00-index.md) | [Main Index](../index.md) | [Gradient Descent -->](04-gradient-descent.md)

---

# Linear Regression

**Requires**: [Train/Test Split](02-train-test-split.md)
...
Closed-form solutions don't always exist, which then requires algorithms like [🖝 Gradient Descent](../part-05-supervised-learning/04-gradient-descent.md) that we discuss next.
...
For evaluating a regression model, the workflow is to fit the model on the training set only (see previous nugget [🖝 Train/Test Split](../part-05-supervised-learning/02-train-test-split.md)), then compute the error on the held-out test set. That test-set error is your honest estimate of how the model generalizes.
