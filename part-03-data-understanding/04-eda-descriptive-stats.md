...
**When to use which** depends largely on the distribution at hand (see [EDA: Distributions](\06-eda-distributions.md)):
...
*See also: [EDA: Distributions](06-eda-distributions.md) covers the boxplot, which visualizes the five-number summary and uses the IQR to flag potential outliers.*
